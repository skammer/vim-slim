...
syn region slimRuby matchgroup=slimRubyOutputChar start="\s*[=]\==[']\=" contained contains=@slimRubyTop keepend
syn region slimRuby matchgroup=slimRubyChar       start="\s*-"           contained contains=@slimRubyTop keepend
